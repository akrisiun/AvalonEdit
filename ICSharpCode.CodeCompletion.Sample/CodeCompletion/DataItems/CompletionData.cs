...
namespace ICSharpCode.CodeCompletion.DataItems
{
    ...
    public interface ISegmentEdit : ISegment // ICSharpCode.AvalonEdit.Document.ISegment
	{
		//int Offset { get; }
		//int Length { get; }
		//int EndOffset { get; }
...
#region NRefactory ICompletionData implementation
        public NRefactory.Completion.CompletionCategory CompletionCategory { get; set; }
        public string DisplayText { get; set; }
        public virtual string Description { get; set; }
        public string CompletionText { get; set; }
        public NRefactory.Completion.DisplayFlags DisplayFlags { get; set; }
...
#region AvalonEdit ICompletionData implementation
        ...
        // Complete(ICSharpCode.AvalonEdit.Editing.TextArea textArea, ISegment completionSegment, EventArgs insertionRequestEventArgs)
        {
